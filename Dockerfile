...
ADD --chown=keycloak:keycloak https://github.com/vymalo/keycloak-webhook/releases/download/v0.5.0/keycloak-webhook-0.5.0.jar /opt/keycloak/providers/keycloak-webhook-0.5.0.jar
